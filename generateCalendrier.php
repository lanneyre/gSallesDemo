...
$resa = reservation::getReservationsByDateFormat($searchDays);
//print_r($resa);
?>

<table class="table table-striped" id="tGlobal">
					...
					<tr>
						<?php for ($j=0; $j < 9 ; $j++) { ?>
							<?php if($j == 0 || $j == 8){ echo "<td class='heure'>".$i.":30</td>"; } else {
								...
								$id = "j".$x."-h".$i."-30";?>
							<td id="<?php echo $id; ?>">
								<?php echo generateCellule($id, $resa); ?>
							</td>
							<?php } ?>
							<?php } ?>
					</tr>
